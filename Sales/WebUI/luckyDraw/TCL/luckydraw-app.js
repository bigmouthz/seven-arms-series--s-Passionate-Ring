...
function change() {
    if (tmpPool.length > 0) {
        ...
        showresult.html("<font style='font-size:6.5em;line-height:70px;color:black;font-family:SimHei;'>" + tmpPool[i].Name + "</font>");
        showresultid.val(tmpPool[i].ID);
        curtmp = tmpPool[i];
    } else {
        showresult.html("<font style='font-size:6.5em;line-height:70px;color:black;font-family:SimHei;'></font>");
        showresultid.val("");
        curtmp = "";
    }
};
...
function viewOXY(rsx) {
    ...
    for (var x = 0; x < rsx.length; x++) {
        ...
        if (tmp) {
            if (count <= 1) {
                rs.push("<font style='font-size:6.5em;line-height:150px;color:black;font-family:SimHei;'>" + tmp.Name + "</font>");

            } else if (count <= 5) {
                rs.push("<font style='font-size:3.0em;line-height:150px;color:black;font-family:SimHei;'>" + tmp.Name + "</font>");
                if (x % 3 == 0) {
                    rs.push("&nbsp;&nbsp;");
                } else if (x % 3 == 1) {
                    rs.push("&nbsp;&nbsp;");
                ...
                rs.push("<font style='font-size:2.0em;line-height:130px;color:black;font-family:SimHei;'>" + tmp.Name + "</font>");
                if (x % 5 == 0) {
                    rs.push("&nbsp;&nbsp;");
                } else if (x % 5 == 1) {
                    rs.push("&nbsp;&nbsp;");
                ...
                rs.push("<font style='font-size:2.0em;line-height:90px;color:black;font-family:SimHei;'>" + tmp.Name + "</font>");
                if (x % 5 == 0) {
                    rs.push("&nbsp;&nbsp;");
                } else if (x % 5 == 1) {
                    rs.push("&nbsp;&nbsp;");
