...
function openProjectNodeFiles(nodeorder) {
    ...
    project = $('#cc').combobox('getValue');
    window.open("projectnodefiles.htm?project=" + project + "&usercode=" + usercode + "&nodeorder=" + nodeorder, '_blank');
}

function openNodeFiles(nodeorder) {
    //window.location.href = '_index.htm';
    window.open("nodefiles.htm?nodeorder=" + nodeorder+"&usercode=" + usercode , '_blank');
}
...
$(function () {
    usercode = common.getUrlParam("usercode");
    try {
