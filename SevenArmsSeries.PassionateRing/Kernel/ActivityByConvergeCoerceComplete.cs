...
namespace SevenArmsSeries.PassionateRing.Kernel
{
    ...
    /// 3、无论该结点的所有导入活动完成与否直接激活本结点，关闭直接导入活动结点
    /// </summary>
    public sealed class ActivityByConvergeCoerceComplete : Activity
    {
        /// <summary>
        /// 活动类型:
        /// </summary>
        public override eActivityType ActivityType { get { return eActivityType.ConvergeCoerceComplete; } set { ;} }
