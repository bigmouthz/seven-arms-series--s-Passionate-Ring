...
namespace SevenArmsSeries.PassionateRing.Kernel
{
    ...
    /// 3、该结点的最近导入活动必须全部完成才允许执行激活本结点
    /// </summary>
    public sealed class ActivityByConvergeWaitLeftComplete : Activity
    {
        /// <summary>
        /// 活动类型:
        /// </summary>
        public override eActivityType ActivityType { get { return eActivityType.ConvergeWaitLeftComplete; } set { ;} }
