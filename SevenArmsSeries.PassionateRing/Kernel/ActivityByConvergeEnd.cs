...
namespace SevenArmsSeries.PassionateRing.Kernel
{
    ...
    /// 3、无论该结点的前的所有活动完成与否直接激活本结点，关闭流程运行
    /// </summary>
    public sealed class ActivityByConvergeEnd : Activity
    {
        /// <summary>
        /// 活动类型:
        /// </summary>
        public override eActivityType ActivityType { get { return eActivityType.ConvergeEnd; } set { ;} }
